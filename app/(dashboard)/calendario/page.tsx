...
const cargar = async () => {
    ...
    const { data: sueltos } = await supabase.from('dias_sueltos').select('*, profiles(nombre, apellidos)').eq('estado', 'disponible')
...
.badge-pedido { font-size: 0.55rem; background: #f5c518; color: #0f0f0f; border-radius: 2px; padding: 0 2px; font-weight: 700; line-height: 1.4; }
...
.badge-espera { font-size: 0.55rem; background: #fb923c; color: #0f0f0f; border-radius: 2px; padding: 0 2px; font-weight: 700; line-height: 1.4; }
