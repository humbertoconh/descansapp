...
function CalendarioContent() {
  ...
  const cargar = async () => {
    ...
    const { data: sueltos } = await supabase.from('dias_sueltos').select('id, user_id, fecha, estado, created_at, profiles(nombre, apellidos)').eq('estado', 'disponible')
    console.log('SUELTOS:', sueltos)
